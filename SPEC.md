...
- / (Home)
- /team
- /project (bike + technical focus)
- /sponsors
- /gallery
- /contact

## Visual style
- Clean motorsport/engineering feel
- Strong hero with 1–2 best photos
...
- Section blocks (title, text, optional image)
- Sponsor grid (logo + link)
